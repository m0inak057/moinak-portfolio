...
# Media files (User uploads like PDFs, images)
# https://docs.djangoproject.com/en/4.2/howto/static-files/
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'moinak.mondal057@gmail.com')
CONTACT_EMAIL = os.getenv('CONTACT_EMAIL', 'moinak.mondal057@gmail.com')
